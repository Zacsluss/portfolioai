  ...
  experience: [
    {
      ...
      achievements: [
        "Led global digital transformation program increasing sales and operational throughput 40%, automating 12,000+ hours annually (~$2.4M cost savings)",
        "Achieved 100% SOX audit readiness with zero compliance breaches by instituting enterprise-wide governance model across 22 countries",
        "Increased deal velocity 30% (translating to $8M+ incremental ARR) by designing global managed services pricing platform with standardized product/pricing models",
        "Enabled board-level decision-making with real-time Salesforce dashboards for forecasting, pipeline insights, and revenue tracking—adopted by C-suite for quarterly board presentations",
        "Provide matrix leadership across 12 global cross-functional teams (60+ people), mentoring 8 junior analysts and managing $3M+ vendor portfolio spanning 11 contracts",
        "Manage portfolio of 12+ concurrent strategic projects annually ensuring enterprise alignment and on-time delivery with 95% success rate",
        "Championed change management initiative to consolidate 5 legacy CRM systems, securing executive buy-in across 8 business units and reducing platform costs by $1.2M annually",
        "Built and scaled global Center of Excellence for Salesforce governance, establishing best practices adopted by 3,000+ users worldwide",
      ],
    ...
    },
    {
      ...
      achievements: [
        "Established API-led integration framework connecting Salesforce with ERP and HCM systems, enabling real-time data synchronization for 3,000+ users",
        "Standardized global processes across 22+ countries ensuring compliance and operational consistency, reducing regional variances by 80%",
        "Led M&A integration efforts for platform consolidation and data migration, successfully onboarding 500+ users from acquired entity within 90 days",
        "Designed automation logic reducing manual processes by 35% (4,200+ hours annually), freeing team capacity for strategic initiatives",
        "Collaborated with senior leadership to define 3-year CRM roadmap aligned with corporate growth strategy",
      ],
